...
# TESTS
add_item(Item("O",Box(Coordinate(-1,-1), Size(2,2)),Vector(1,1)))
add_item(Item("-",Box(Coordinate(-9,-10), Size(18,1)),Vector(0,0)))
add_item(Item("|",Box(Coordinate(-10,-9), Size(1,18)),Vector(0,0)))
add_item(Item("|",Box(Coordinate( 9,-9), Size(1,18)),Vector(0,0)))
add_item(Item("-",Box(Coordinate(-9, 9), Size(18,1)),Vector(0,0)))
def clear():
	for i in range(100):
		print("")
clear()
